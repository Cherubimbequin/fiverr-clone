    ...
    <nav  class="p-0 fixed-top text-white" id="top-nav">
      <div class="top-nav row mx-auto my-auto pt-3 pb-3 w-100 container-fluid text-white">
        ...
        <ul class="d-none d-md-flex text-white col-auto row fw-semibold my-auto">
          ...
          <li id="google_translate_element" class="col-auto d-none d-lg-block"> </li>
    ...
    <nav class="mobile-nav text-nowrap" id="mobile-nav">
      <div class="fixed-top text-muted bg-white vh-100 px-3 pt-3" id="sidebar">
        ...
        <ul class="fw-normal d-flex flex-column mx-auto">
          ...
          <li class="col-auto my-2 fs-6">₹ INR</li>
        </ul>
      </div>
    ...
    <section class="hero d-flex justify-content-start ps-md-5 px-2">
      <div class="content text-white d-flex flex-column justify-content-center align-items-center align-items-md-start text-center text-md-start">
        ...
        <div class="input-group fw-semibold w-100 mx-auto d-flex justify-content-center justify-content-md-start"
          ...
          <input class="border-0 px-3 w-75" style="border-radius: 5px 0 0 5px;" placeholder='Try "building mobile app"'
            type="text" name="search" id="search">
          <input class="border-0 px-4 text-white"
            style="background-color: var(--primary--color-p); border-radius: 0 5px 5px 0;" type="button" value="Search">
        </div>
        ...
        <div class="qlts-content col-md-5 col-12">
          ...
          <ul class="d-flex flex-column">
            <li>
              ...
              <p class="text-muted" style="font-size: 1.2rem;">Find high-quality services at every price point. No hourly
                rates, just
                project-based
                pricing.</p>
            </li>
            <li>
              ...
              <p class="text-muted" style="font-size: 1.2rem;">Find the right freelancer to begin working on your project
                within minutes.</p>
            </li>
            <li>
              <div>
              ...
              <p class="text-muted" style="font-size: 1.2rem;">Always know what you'll pay upfront. Your payment isn't
            ...
            <li>
              ...
              <p class="text-muted" style="font-size: 1.2rem;">Questions? Our round-the-clock support team is available to
    ...
    <section class="fvr-busns py-5 px-3 px-sm-4 px-md-5 text-white" style="background-color: #0d084d;">
      <div class="my-5 row align-items-center">
        <div class="fvr-busns-content col-md-5 col-12">
          ...
          <p class="fs-5 ">Upgrade to a curated experience packed with tools and benefits, dedicated to businesses</p>
          <ul class="d-flex flex-column">
            <li class="d-flex my-1 align-items-start">
              <img src="assets/svg/tick.svg" alt="success">
              <p style="font-size: 1.1rem;" class="ms-3">Connect to freelancers with proven business experience</p>
            </li>
            <li class="d-flex my-1 align-items-start">
              <img src="assets/svg/tick.svg" alt="success">
              <p style="font-size: 1.1rem;" class="ms-3">Get matched with the perfect talent by a customer success
                manager</p>
            </li>
            <li class="d-flex my-1 align-items-start">
              <img src="assets/svg/tick.svg" alt="success">
              <p style="font-size: 1.1rem;" class="ms-3">Manage teamwork and boost productivity with one powerful
                workspace</p>
            </li>
          </ul>
        </div>
      ...
      <div class="guides-wrapper">
        ...
        <div class="guides-posts d-flex flex-wrap justify-content-xl-between" style="gap: 10px;">
          <div class="guide-post" style="width: 390px; max-width: 100%; cursor: pointer;">
            ...
            <h6 class="mt-3 mb-0 fw-semibold" style="font-size: 1.1rem;">Start an online business and work from home</h6>
            <p class="text-muted" style="font-size: 1.05rem;">A complete guide to starting a small business online</p>
          </div>
          <div class="guide-post" style="width: 390px; max-width: 100%; cursor: pointer;">
            ...
            <p class="text-muted" style="font-size: 1.05rem;">A practical guide to understand what is digital marketing</p>
          </div>
          <div class="guide-post" style="width: 390px; max-width: 100%; cursor: pointer;">
            ...
            <p class="text-muted" style="font-size: 1.05rem;">A step-by-step guide to create a memorable business logo</p>
          </div>
        </div>
      </div>
    </section>
  ...
  <footer class="footer pt-5 pb-3 px-3 px-sm-4 px-md-5 border-top border-1 border-opacity-10 text-muted">
    ...
    <div
      ...
      <div class="footer-rights d-flex flex-column flex-md-row justify-content-center align-items-center"
        ...
        <div id="copyright" class="text-center align-middle my-auto">© Fiverr International Ltd. <span id="year"></span></div>
      </div>
      <div class="footer-social d-flex flex-column flex-md-row justify-content-center align-items-center"
        ...
        <ul class="d-flex align-items-center my-auto">
          <li id="google_translate_element" class="p-2">
          </li>
        </ul>
      </div>
    </div>
